...
#define pinEnable    13  // PWM or Enable pins
#define pinStep      9  // Step 3
#define pinDir       8  // Direction 2
#define pinEnable_2  4 // PWM or enable pins
#define pinStep_2    3  // Step 92
#define pinDir_2     2  // Direction  8
